...
@Time:2025/6/17 17:15
@File:http_ryu_server.py
@Desc:用于共享ryu内部数据
"""
#!/usr/bin/env python3
# -*- coding:utf-8 -*-
...
@app.route('/')
def home():
    return "Welcome to API Data Server! Use /api/path_table"


@app.route('/api/path_table',methods=['GET','POST'])
def upload_state():
    transit_folder = './api/data/path_table.json'
...
def _clear():
    ...
    for file in ['./api/data/path_table.json']:
        try:
