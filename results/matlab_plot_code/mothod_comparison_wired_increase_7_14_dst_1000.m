...
% 随机目的的数据
data1 = readmatrix('../plot_data/DDPG_7800_eva_value_data_2025-07-14-10-35-04_7_14_SP_15.csv')
...
% 最短最短路径
data2 = readmatrix('../plot_data/DDPG_9150_eva_value_data_2025-07-14-15-09-18_7_14_SP_16.csv')
x2 = data2(1:sample_number,1)
y2 = data2(1:sample_number,2)
mov_y2 = moving_average(y2,window_size)

% 最短最短路径
data3 = readmatrix('../plot_data/DDPG_7950_eva_value_data_2025-07-14-09-52-47_7_14_random.csv')
