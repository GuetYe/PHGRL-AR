...
% 确定目的15
data1 = readmatrix('../plot_data/SAC_14800_eva_value_data_2025-08-14-11-09-56_15.csv');
x1 = data1(data_index,1);
y1 = data1(data_index,2);
mov_y1 = moving_average(y1,window_size);



% 确定目的16
data2 = readmatrix('../plot_data/SAC_8200_eva_value_data_2025-08-14-15-29-14_16.csv');
x2 = data2(data_index,1);
y2 = data2(data_index,2);
