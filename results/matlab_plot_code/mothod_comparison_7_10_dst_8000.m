...
% 随机目的的数据
data1 = readmatrix('../plot_data/DDPG_1550_eva_value_data_2025-07-10-22-06-02_SP_15_8000.csv')
...
% 最短最短路径
data2 = readmatrix('../plot_data/DDPG_1500_eva_value_data_2025-07-11-09-22-52_random_8000.csv')
