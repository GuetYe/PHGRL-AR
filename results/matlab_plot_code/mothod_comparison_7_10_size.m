...
% 随机目的的数据
data1 = readmatrix('../plot_data/DDPG_2600_eva_value_data_2025-07-09-16-01-45_SP_17.csv')
...
% 最短最短路径
data2 = readmatrix('../plot_data/DDPG_3350_eva_value_data_2025-07-09-21-50-36_SP_17_1000.csv')
...
%% 结论: 动态流表的情况下，固定17时，2000的时延要比1000多一倍不止
