...
opts = detectImportOptions('../plot_data/DDPG_8400_eva_value_data_2025-07-08-09-32-21_control.csv');
data = readtable('../plot_data/DDPG_8400_eva_value_data_2025-07-08-09-32-21_control.csv',opts);
...
% 随机目的的数据
data1 = readmatrix('../plot_data/DDPG_5650_eva_value_data_2025-07-07-09-27-29_random.csv')
...
% 最短最短路径
data2 = readmatrix('../plot_data/DDPG_5750_eva_value_data_2025-07-08-17-32-30_SSP.csv')
