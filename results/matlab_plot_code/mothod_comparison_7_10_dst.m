...
% 随机目的的数据
data1 = readmatrix('../plot_data/DDPG_6900_eva_value_data_2025-07-10-11-49-28_SP_15.csv')
...
% 最短最短路径
data2 = readmatrix('../plot_data/DDPG_3950_eva_value_data_2025-07-10-09-47-01_random.csv')
...
%% 结论: 2000 的情况下固定流表选15优于固定流表随机目标的情况
