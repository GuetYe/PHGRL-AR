...
% 随机目的的数据
data1 = readmatrix('../plot_data/DDPG_2450_eva_value_data_2025-07-13-23-00-35_test_wired_7_13_15.csv')
...
% 最短最短路径
data2 = readmatrix('../plot_data/DDPG_2150_eva_value_data_2025-07-14-09-27-27_test_wired_7_14_random.csv')
x2 = data2(1:sample_number,1)
y2 = data2(1:sample_number,2)
mov_y2 = moving_average(y2,window_size)

% % 最短最短路径
% data3 = readmatrix('../plot_data/DDPG_8050_eva_value_data_2025-07-11-12-08-26_7_13_random.csv')
% x3 = data3(1:sample_number,1)
% y3 = data3(1:sample_number,2)
% mov_y3 = moving_average(y3,window_size)
% 
% % 最短最短路径
% data4 = readmatrix('../plot_data/DDPG_9850_eva_value_data_2025-07-13-16-04-40_7_13_random.csv')
