...
from algorithms_model import HighDDPG,LowDDPG,gen_high_act_input_batch,gen_low_act_input_batch,HighPPO
import numpy as np
import torch
import re
import asyncio
    ...
    def evaluate_loop(self):
        ...
        while self._running:
            ...
            if len(self.agents_list)>0:
                ...
                high_reward_ave, low_reward_dict_ave = self.evaluate(high_agent, low_agent, num_sample=setting.high_buffer_req_size)
